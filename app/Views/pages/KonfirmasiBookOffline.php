...
<div class="container konfirm">
      ...
      <a href="<?php echo base_url('Booking/terkonfirmasiOffline')?>?id_booking=<?= $booking[0]['id_booking']; ?>" type="button" class="btn btn-primary biru mt-2">
        Konfirmasi
      </a>
      ...
      Batalkan</a>
      <a href="<?php echo base_url('Booking/printpdfBookOff')?>?id_booking=<?= $booking[0]['id_booking']; ?>" type="button" class="btn btn-secondary mt-2">
      Print PDF</a>
     ...
     <p>Anda Melakukan Booking atau reservasi dengan pembayaran Offline yang mana pembayaran tersebut dilakukan secara langsung ketika anda datang ke lokasi pada saat janji temu telah dilaksanakan.</p> 
