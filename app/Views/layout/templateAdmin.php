...
<html lang="en">
  ...
  <body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
      <!-- Navbar Brand-->
      <a class="navbar-brand ps-3" href="index.html">Salon Ungu</a>
      <!-- Sidebar Toggle-->
      <button
      ...
      <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
        <li class="nav-item dropdown">
          ...
          >
            ...
            <li><a class="dropdown-item" href="<?php echo base_url('Admin/Login_admin/logout'); ?>">Logout</a></li>
          </ul>
        </li>
      </ul>
    </nav>
    <div id="layoutSidenav">
        ...
        <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
          <div class="sb-sidenav-menu">
            <div class="nav">
              ...
              <div class="sb-sidenav-menu-heading">Menu akses</div>
              ...
              <a class="nav-link" href="<?= base_url('admin/Data_layanan')?>">
                <div class="sb-nav-link-icon"><i class="fas fa-table"></i></div>
                Data Layanan
              </a>
              ...
              <a class="nav-link" href="<?= base_url('admin/Data_laporan')?>">
                <div class="sb-nav-link-icon"><i class="fas fa-table"></i></div>
                Laporan
              </a>
            </div>
      ...
      <footer class="py-4 bg-light mt-auto">
          <div class="container-fluid px-4">
            ...
            >
              <div class="text-muted">Copyright &copy; Salon Ungu 2022</div>
            </div>
          </div>
        </footer>
      </div>
